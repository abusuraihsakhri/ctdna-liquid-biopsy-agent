"""
Automated Pytest for ctdna-liquid-biopsy-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    OverviewEngine,
    CtdnaMolecularResidualDiseaseMrdTrackingWithVafTrendsEngine,
    GoalEngine,
    DataModelChangesEngine,
    NewModuleEngine,
    AgentChangesEngine,
    ComputeRelapseRiskScoreEngine,
    ApiChangesEngine,
    CtdnaliquidbiopsyagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CtdnaliquidbiopsyagentEnrichmentSuite()
