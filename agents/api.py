"""
FastAPI REST API Server for Ctdna Liquid Biopsy Agent.
"""
...
app = FastAPI(
    title="Ctdna Liquid Biopsy Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "ctdna-liquid-biopsy-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
